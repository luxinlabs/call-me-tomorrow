...
from simulation import build_future_me_prompt
...
async def run_session(
    ...
    onboarding_answers = get_onboarding_answers(int(user_id)) if user_id != "anon" else {}
    ...
    tool_functions = [offer_suggestion, deliver_action_plan, end_call]
    ...
    # Build Future Me prompt directly from onboarding profile
    archetype = assign_archetype(onboarding_answers)
    current_archetype = archetype.name
    memory_ctx = await get_memory_context(user_id, channel_id, onboarding_answers.get("goal", ""))
    ...
    llm = VLLMOpenAILLMService(
        ...
        settings=VLLMOpenAILLMService.Settings(
            ...
            system_instruction=future_me_prompt,
